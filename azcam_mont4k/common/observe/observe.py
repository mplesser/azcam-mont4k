...
class Observe(QtGui.QMainWindow):
    """
    ...
    def _init_observe_gui(self, parent=None):
        ...
        self.script_file = azcam.api.get_parfile_par(
            "observe", "script_file", "default", "", "observing_script.txt"
        )
        self.ui.plainTextEdit_filename.setPlainText(self.script_file)

        number_cycles = azcam.api.get_parfile_par("observe", "number_cycles", "default", "", 1)
    ...
    def observe(self, script_file="prompt", number_cycles=1):
        ...
        if script_file == "prompt":
            script_file = azcam.api.get_parfile_par(
            ...
            if script_file != None and script_file != "":
        ...
        if number_cycles == "prompt":
            self.number_cycles = azcam.api.get_parfile_par(
        ...
        if expose_flag:
            for i in range(numexposures):
                ...
                if self.move_telescope_during_readout and (raNext != ""):
                    ...
                    if 1:
                        # if not self.debug:
                        reply = expose1(exptime, imagetype, title)  # immediate return
                        ...
                        while 1:
                            ...
                            if (
                                ...
                                if doMove:
                                    ...
                                    while check_header:
                                        header_updating = int(
                                            azcam.api.get_attr("exposure", "updating_header")
                                        )
                                        if header_updating:
    ...
    def select_script(self):
        ...
        self.ui.plainTextEdit_filename.setPlainText(
    ...
    def cell_changed(self, item):
        ...
        oldvalue = self.commands[row][colnum]
    ...
    def update_table(self):
        ...
        for row, data1 in enumerate(self.commands):
            ...
            for key in self.column_order:
                newitem = QtGui.QTableWidgetItem(str(data1[key]))
    ...
    def highlight_row(self, row_number, flag):
        ...
        numrows = self.ui.tableWidget_script.rowCount()
